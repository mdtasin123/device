...
for xd in range (50000):
	...
	c='Infinix X695 Build/RP1A.200720.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/'
	d=random.randrange(40,109)
	e='0'
...
models=requests.get("https://raw.githubusercontent.com/mdtasin123/device/main/SamsungDevices.txt").text.splitlines()
...
def generate_FBAN():
  ...
  ua=f"[FBAN/FB4A;FBAV/{FBAV};FBBV/{FBBV};FBDM/"+"{density=2.5,width=1440,height=780}"+f";FBLC/en_FR;FBRV/0;FBCR/{FBCR};FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.katana;FBDV/{device};FBSV/{android_version};FBOP/1;FBCA/x64:arm-v8a;]"
  return ua
